 ...
 */
export declare function registerMiddleware(provider: any | IProvider<any>, instance?: any): void;
/**
 * Add a new middleware in the `ProviderRegistry`. This middleware will be built when `InjectorService` will be loaded.
 *
 * #### Example
 ...
 * @param provider Provider configuration.
 */
export declare function registerMiddlewareError(provider: any | IProvider<any>, instance?: any): void;
