...
const ProviderScope_1 = require("../../di/interfaces/ProviderScope");
/**
...
class ServerSettingsService {
    constructor() {
        ...
        this.debug = false;
        this.controllerScope = ProviderScope_1.ProviderScope.SINGLETON;
        this.logger = {
            debug: false,
            logRequest: true,
     ...
     */
    set debug(debug) {
        this.logger = Object.assign({}, this.logger, { debug });
    }
    /**
     *
...
tslib_1.__decorate([
    ...
    tslib_1.__metadata("design:returntype", ServerSettingsService)
], ServerSettingsService.prototype, "$get", null);
exports.ServerSettingsService = ServerSettingsService;
/**
 * @deprecated
 */
class ServerSettingsProvider extends ServerSettingsService {
}
exports.ServerSettingsProvider = ServerSettingsProvider;
ProviderRegistry_1.registerFactory(ServerSettingsService);
