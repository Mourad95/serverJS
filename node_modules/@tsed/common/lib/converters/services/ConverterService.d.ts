...
export declare class ConverterService {
     ...
     * @param options
     */
    private convertProperty(obj, instance, propertyName, propertyMetadata?, options?);
    /**
     *
     * @param instance
     * @param {Map<string | symbol, PropertyMetadata>} properties
     */
    private checkRequiredValue(instance, properties);
    /**
     *
     * @param instance
     ...
     */
    private checkStrictModelValidation(instance, propertyKey, propertyMetadata);
    /**
     *
     * @param {Type<any>} target
     * @returns {boolean}
     */
    private isStrictModelValidation(target);
}
