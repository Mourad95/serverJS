...
var LayoutReplacer = /** @class */ (function () {
    function LayoutReplacer(tokens, timezoneOffset) {
        ...
        this.formatMessage = function (loggingEvent) {
            return inpectUtils_1.formatLogData(loggingEvent.data);
        };
        /**
         *
        ...
        this.startColour = function (loggingEvent) {
            return colorizeUtils_1.colorizeStart(logColors_1.LOG_COLORS[loggingEvent.level.toString()]);
        };
        /**
         *
         * @param loggingEvent
        ...
        this.endColour = function (loggingEvent) {
            return colorizeUtils_1.colorizeEnd(logColors_1.LOG_COLORS[loggingEvent.level.toString()]);
        };
        /**
         *
         * @returns {string}
